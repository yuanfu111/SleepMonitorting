%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%             README -- CASE_dataset/interpolated/physiological
%
...
for each sensor (see the list above). This is done using the formulas provided
by the manufacturer. Please see the data descriptor for more details on this
topic.
